...
public class VelocityCompensationCalculator {
    ...
    public static double kRad = 12;
    public static double kTan = 8;
    ...
    public static final double[] SPEEDS =
            {1283, 1238, 1216, 1030, 1161, 1118, 1013, 993, 980, 1433, 1547, 1493};

    public static final double[] HOODS = {Math.toRadians(49.423339408),
            Math.toRadians(48.1914801485), Math.toRadians(46.9653504669), Math.toRadians(40.0),
            Math.toRadians(46.1460208198), Math.toRadians(44.9141615603), Math.toRadians(40.0),
            Math.toRadians(40.0), Math.toRadians(40.0), Math.toRadians(53.1074580307),
            Math.toRadians(54.7461173248), Math.toRadians(55.9779765843)};
    ...
    public static Pose getFuturePose(Pose currentPose, Vector velocityCompensation) {
        return new Pose(currentPose.getX() + velocityCompensation.getXComponent(),
