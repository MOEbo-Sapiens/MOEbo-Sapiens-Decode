...
public class VelocityCompensationCalculator {
    ...
    private static final double[] CLOSE_DISTANCES = new double[] {
            distance(new Pose(24, 120), Constants.BLUE_GOAL_POSE.mirror())+2.42,
            distance(new Pose(48, 96), Constants.BLUE_GOAL_POSE.mirror())+2.42,
            distance(new Pose(60, 84), Constants.BLUE_GOAL_POSE.mirror())+2.42,
            distance(new Pose(72, 72), Constants.BLUE_GOAL_POSE.mirror())+2.42,
            distance(new Pose(88, 85), Constants.BLUE_GOAL_POSE.mirror())+2.42,
            distance(new Pose(90, 90), Constants.BLUE_GOAL_POSE.mirror())+2.42,
            distance(new Pose(96, 96), Constants.BLUE_GOAL_POSE.mirror())+2.42,
            distance(new Pose(102, 102), Constants.BLUE_GOAL_POSE.mirror())+2.42,
    };
    private static final double[] CLOSE_SPEEDS = {
            1314,
            1240,
            1228,
            1220,
    ...
    private static final double[] CLOSE_HOODS = {
            Math.toRadians(47.3721505014),
            Math.toRadians(46.1460208198),
            Math.toRadians(42.45),
    ...
    private static final double[] FAR_DISTANCES = new double[] {
            distance(new Pose(72, 24), Constants.BLUE_GOAL_POSE)+2.42,
            distance(new Pose(60, 12), Constants.BLUE_GOAL_POSE)+2.42,
            distance(new Pose(84, 12), Constants.BLUE_GOAL_POSE)+2.42
    };
    private static final double[] FAR_SPEEDS = {
            1522.7,
            1525,
            1540
    };
    private static final double[] FAR_HOODS = {
            Math.toRadians(56.7973062313),
